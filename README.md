...
| <a href="https://github.com/oluwatobindom/PortfolioProjects/blob/main/PYTHON/NHANES%20II%20-%20Data%20Exploration.ipynb" target="_blank">The National Health and Nutrition Examination Survey (NHANES) II</a> | A deeper dive into the NHANES dataset using statistical methods and data visualization techniques in Jupyter Notebook | Statsmodel, Scipy, Linegress, Pandas, Numpy, Matplotlib, Seaborn  |
